                                                ...
                                                <div className="footer-one__contact-box">
                                                    <ul>
                                                        <li>
                                                            ...
                                                            <div className="text-box">
                                                                <p>Syria St, Rushdy Alexandria Egypt<br /> </p>
                                                            </div>
                                                        </li>
                                                        ...
                                                        <li>
                                                            ...
                                                            <div className="text-box">
                                                                <p><Link href="mailto:alwafaexportgroup@gmail.com">alwafaexportgroup@gmail.com</Link></p>
                                                        ...
                                                        <li>
                                                            ...
                                                            <div className="text-box">
                                                                <p><Link href="tel:+61 420 22 22 55">+61 420 22 22 55</Link></p>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                </div>
